...
Alle verpflichtenden Implementierungsdetails aus [SMART App Launch - 2.0.12 - Refresh access token](http://build.fhir.org/ig/HL7/smart-app-launch/app-launch.html#step-7-refresh) MÜSSEN durch den Autorisierungsserver unterstützt werden.